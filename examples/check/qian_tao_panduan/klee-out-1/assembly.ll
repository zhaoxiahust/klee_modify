...
@.str = private constant [14 x i8] c"inputkkkkkkkk\00", align 1
@.str1 = private constant [24 x i8] c"kkkkkkkkkkkkkkkkkkkkkkk\00", align 1
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %kk, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !66
  %1 = load i32* %j, align 4, !dbg !67
  %2 = icmp sgt i32 %1, 100, !dbg !67
  br i1 %2, label %bb, label %return, !dbg !67

bb:                                               ; preds = %entry
  %3 = load i32* %mm, align 4, !dbg !68
  %4 = icmp sgt i32 %3, 200, !dbg !68
  br i1 %4, label %bb1, label %return, !dbg !68

bb1:                                              ; preds = %bb
  %5 = load i32* %c, align 4, !dbg !69
  %6 = icmp sgt i32 %5, 300, !dbg !69
  br i1 %6, label %bb2, label %return, !dbg !69

bb2:                                              ; preds = %bb1
  %7 = load i32* %kk, align 4, !dbg !70
  %8 = icmp sgt i32 %7, 400, !dbg !70
  br i1 %8, label %bb3, label %return, !dbg !70

bb3:                                              ; preds = %bb2
  %9 = call i32 @puts(i8* getelementptr inbounds ([24 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !71
  br label %return, !dbg !71

return:                                           ; preds = %entry, %bb, %bb1, %bb2, %bb3
  %retval5 = load i32* %retval, !dbg !72
  ret i32 %retval5, !dbg !72
}
...
!1 = metadata !{i32 524329, metadata !"kkkk.c", metadata !"/home/kain/Documents/bishe/klee/examples/check/qian_tao_panduan/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"kkkk.c", metadata !"/home/kain/Documents/bishe/klee/examples/check/qian_tao_panduan/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TA
...
!67 = metadata !{i32 18, i32 0, metadata !65, null}
!68 = metadata !{i32 19, i32 0, metadata !65, null}
!69 = metadata !{i32 20, i32 0, metadata !65, null}
!70 = metadata !{i32 21, i32 0, metadata !65, null}
!71 = metadata !{i32 22, i32 0, metadata !65, null}
!72 = metadata !{i32 23, i32 0, metadata !65, null}
