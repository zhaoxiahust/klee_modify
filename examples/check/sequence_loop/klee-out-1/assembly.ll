...
@.str1 = private constant [11 x i8] c"input22222\00", align 1
@.str2 = private constant [3 x i8] c"hi\00", align 1
@.str3 = private constant [6 x i8] c"world\00", align 1
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !64
  %1 = call i32 (...)* @klee_make_symbolic(i32* %cc, i64 4, i8* getelementptr inbounds ([11 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !66
  store i32 0, i32* %i, align 4, !dbg !67
  br label %bb1, !dbg !67

bb:                                               ; preds = %bb1
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !68
  %3 = load i32* %i, align 4, !dbg !67
  %4 = add nsw i32 %3, 1, !dbg !67
  store i32 %4, i32* %i, align 4, !dbg !67
  br label %bb1, !dbg !67

bb1:                                              ; preds = %bb, %entry
  %5 = load i32* %c, align 4, !dbg !67
  %6 = load i32* %i, align 4, !dbg !67
  %7 = icmp slt i32 %6, %5, !dbg !67
  br i1 %7, label %bb, label %bb2, !dbg !67
...
bb3:                                              ; preds = %bb4
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !70
  %9 = load i32* %i, align 4, !dbg !69
  %10 = add nsw i32 %9, 1, !dbg !69
  store i32 %10, i32* %i, align 4, !dbg !69
  br label %bb4, !dbg !69

bb4:                                              ; preds = %bb3, %bb2
  %11 = load i32* %cc, align 4, !dbg !69
  %12 = load i32* %i, align 4, !dbg !69
  %13 = icmp slt i32 %12, %11, !dbg !69
  br i1 %13, label %bb3, label %return, !dbg !69
...
!1 = metadata !{i32 524329, metadata !"hhhhh.c", metadata !"/home/kain/Documents/bishe/klee/examples/check/sequence_loop/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"hhhhh.c", metadata !"/home/kain/Documents/bishe/klee/examples/check/sequence_loop/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_
...
!10 = metadata !{i32 524329, metadata !"memcpy.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !11} ; [ DW_TAG_file_type ]
!11 = metadata !{i32 524305, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!19 = metadata !{i32 524329, metadata !"memmove.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !20} ; [ DW_TAG_file_type ]
!20 = metadata !{i32 524305, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!28 = metadata !{i32 524329, metadata !"memset.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !29} ; [ DW_TAG_file_type ]
!29 = metadata !{i32 524305, i32 0, i32 1, metadata !"memset.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!66 = metadata !{i32 12, i32 0, metadata !65, null}
!67 = metadata !{i32 13, i32 0, metadata !65, null}
!68 = metadata !{i32 15, i32 0, metadata !65, null}
!69 = metadata !{i32 17, i32 0, metadata !65, null}
!70 = metadata !{i32 19, i32 0, metadata !65, null}
!71 = metadata !{i32 21, i32 0, metadata !65, null}
