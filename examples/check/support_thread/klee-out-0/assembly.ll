...
entry:
  ...
  %3 = load i32* %m, align 4, !dbg !70
  %4 = icmp sgt i32 %3, 80, !dbg !70
  br i1 %4, label %bb, label %bb1, !dbg !70

bb:                                               ; preds = %entry
  %5 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !71
  br label %return, !dbg !71

bb1:                                              ; preds = %entry
  %6 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !72
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %m, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !74
  %m1 = bitcast i32* %m to i8*, !dbg !76
  %1 = call i32 @pthread_create(i64* noalias %thread, %union.pthread_attr_t* noalias null, i8* (i8*)* @func, i8* noalias %m1) nounwind, !dbg !76
...
!1 = metadata !{i32 524329, metadata !"thread.c", metadata !"/home/kain/Documents/bishe/klee/examples/check/support_thread/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"thread.c", metadata !"/home/kain/Documents/bishe/klee/examples/check/support_thread/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TA
...
!6 = metadata !{i32 524334, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 16, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 false, i32 (i32, i8**)* @main} ; [ DW_TAG_subprogram ]
...
!70 = metadata !{i32 9, i32 0, metadata !69, null}
!71 = metadata !{i32 10, i32 0, metadata !69, null}
!72 = metadata !{i32 12, i32 0, metadata !69, null}
!73 = metadata !{i32 13, i32 0, metadata !69, null}
!74 = metadata !{i32 20, i32 0, metadata !75, null}
!75 = metadata !{i32 524299, metadata !6, i32 16, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!76 = metadata !{i32 23, i32 0, metadata !75, null}
!77 = metadata !{i32 26, i32 0, metadata !75, null}
