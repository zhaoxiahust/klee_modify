...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %m, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !64
  %1 = load i32* %m, align 4, !dbg !66
  %2 = icmp eq i32 %1, 77, !dbg !66
  br i1 %2, label %bb, label %bb1, !dbg !66

bb:                                               ; preds = %entry
  %3 = call i32 @putchar(i32 104) nounwind, !dbg !67
  br label %bb1, !dbg !67

bb1:                                              ; preds = %bb, %entry
  %4 = load i64* %thread, align 8, !dbg !68
  %5 = call i32 @pthread_join(i64 %4, i8** null) nounwind, !dbg !68
  %retval2 = load i32* %retval, !dbg !69
  ret i32 %retval2, !dbg !69
}
...
!65 = metadata !{i32 524299, metadata !0, i32 6, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
