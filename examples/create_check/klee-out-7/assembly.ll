...
@.str1 = private constant [10 x i8] c"into >100\00", align 1
@.str2 = private constant [11 x i8] c"into <=100\00", align 1
...
entry:
  ...
  %1 = load i32* %c, align 4, !dbg !66
  %2 = icmp sgt i32 %1, 100, !dbg !66
  br i1 %2, label %bb, label %bb1, !dbg !66

bb:                                               ; preds = %entry
  %3 = call i32 @puts(i8* getelementptr inbounds ([10 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !67
  br label %return, !dbg !67

bb1:                                              ; preds = %entry
  %4 = call i32 @puts(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !68
  br label %return, !dbg !68

return:                                           ; preds = %bb, %bb1
  %retval3 = load i32* %retval, !dbg !69
  ret i32 %retval3, !dbg !69
}
...
!1 = metadata !{i32 524329, metadata !"hhhhh.c", metadata !"/home/kain/Documents/bishe/klee/examples/create_check/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"hhhhh.c", metadata !"/home/kain/Documents/bishe/klee/examples/create_check/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile
...
!64 = metadata !{i32 9, i32 0, metadata !65, null}
...
!68 = metadata !{i32 16, i32 0, metadata !65, null}
