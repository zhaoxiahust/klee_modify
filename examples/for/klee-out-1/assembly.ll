...
@.str = private constant [11 x i8] c"inputccccc\00", align 1
@.str1 = private constant [3 x i8] c"hi\00", align 1
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([11 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !64
  store i32 0, i32* %i, align 4, !dbg !66
  br label %bb1, !dbg !66

bb:                                               ; preds = %bb1
  %1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !67
  %2 = load i32* %i, align 4, !dbg !66
  %3 = add nsw i32 %2, 1, !dbg !66
  store i32 %3, i32* %i, align 4, !dbg !66
  br label %bb1, !dbg !66

bb1:                                              ; preds = %bb, %entry
  %4 = load i32* %c, align 4, !dbg !66
  %5 = load i32* %i, align 4, !dbg !66
  %6 = icmp slt i32 %5, %4, !dbg !66
  br i1 %6, label %bb, label %return, !dbg !66

return:                                           ; preds = %bb1
  %retval3 = load i32* %retval, !dbg !68
  ret i32 %retval3, !dbg !68
}
...
!1 = metadata !{i32 524329, metadata !"hhhhh.c", metadata !"/home/kain/Documents/bishe/klee/examples/for/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"hhhhh.c", metadata !"/home/kain/Documents/bishe/klee/examples/for/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!64 = metadata !{i32 10, i32 0, metadata !65, null}
