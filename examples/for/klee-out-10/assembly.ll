...
@.str2 = private constant [42 x i8] c"rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr\00", align 8
...
bb:                                               ; preds = %bb8
  %1 = load i32* %mm, align 4, !dbg !68
  %2 = icmp eq i32 %1, 8, !dbg !68
  br i1 %2, label %bb1, label %bb5, !dbg !68
...
bb2:                                              ; preds = %bb3
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !70
  %4 = load i32* %i, align 4, !dbg !69
  %5 = add nsw i32 %4, 1, !dbg !69
  store i32 %5, i32* %i, align 4, !dbg !69
  br label %bb3, !dbg !69

bb3:                                              ; preds = %bb2, %bb1
  %6 = load i32* %c, align 4, !dbg !69
  %7 = load i32* %i, align 4, !dbg !69
  %8 = icmp slt i32 %7, %6, !dbg !69
  br i1 %8, label %bb2, label %bb7, !dbg !69

bb5:                                              ; preds = %bb
  %9 = load i32* %c, align 4, !dbg !71
  %10 = icmp sgt i32 %9, 1000, !dbg !71
  br i1 %10, label %bb6, label %bb7, !dbg !71

bb6:                                              ; preds = %bb5
  %11 = call i32 @puts(i8* getelementptr inbounds ([42 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !72
  br label %bb7, !dbg !72

bb7:                                              ; preds = %bb3, %bb6, %bb5
  %12 = load i32* %j, align 4, !dbg !67
  %13 = add nsw i32 %12, 1, !dbg !67
  store i32 %13, i32* %j, align 4, !dbg !67
  br label %bb8, !dbg !67

bb8:                                              ; preds = %bb7, %entry
  %14 = load i32* %j, align 4, !dbg !67
  %15 = load i32* %cc, align 4, !dbg !67
  %16 = icmp slt i32 %14, %15, !dbg !67
  br i1 %16, label %bb, label %return, !dbg !67

return:                                           ; preds = %bb8
  %retval10 = load i32* %retval, !dbg !73
  ret i32 %retval10, !dbg !73
}
...
!66 = metadata !{i32 15, i32 0, metadata !65, null}
...
!71 = metadata !{i32 27, i32 0, metadata !65, null}
!72 = metadata !{i32 29, i32 0, metadata !65, null}
!73 = metadata !{i32 33, i32 0, metadata !65, null}
