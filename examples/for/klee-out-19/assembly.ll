...
bb:                                               ; preds = %bb1
  %2 = load i32* %j, align 4, !dbg !68
  %3 = add nsw i32 %2, 1, !dbg !68
  store i32 %3, i32* %j, align 4, !dbg !68
  br label %bb1, !dbg !68

bb1:                                              ; preds = %bb, %entry
  %4 = load i32* %kk, align 4, !dbg !68
  %5 = load i32* %j, align 4, !dbg !68
  %6 = icmp slt i32 %5, %4, !dbg !68
  br i1 %6, label %bb, label %bb2, !dbg !68
...
bb3:                                              ; preds = %bb4
  %7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !70
  %8 = load i32* %i, align 4, !dbg !69
  %9 = add nsw i32 %8, 1, !dbg !69
  store i32 %9, i32* %i, align 4, !dbg !69
  br label %bb4, !dbg !69

bb4:                                              ; preds = %bb3, %bb2
  %10 = load i32* %c, align 4, !dbg !69
  %11 = load i32* %i, align 4, !dbg !69
  %12 = icmp slt i32 %11, %10, !dbg !69
  br i1 %12, label %bb3, label %return, !dbg !69
...
!69 = metadata !{i32 25, i32 0, metadata !65, null}
!70 = metadata !{i32 27, i32 0, metadata !65, null}
