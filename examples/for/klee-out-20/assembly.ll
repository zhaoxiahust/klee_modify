...
bb1:                                              ; preds = %bb2
  %1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !69
  %2 = load i32* %i, align 4, !dbg !68
  %3 = add nsw i32 %2, 1, !dbg !68
  store i32 %3, i32* %i, align 4, !dbg !68
  br label %bb2, !dbg !68

bb2:                                              ; preds = %bb1, %bb
  %4 = load i32* %c, align 4, !dbg !68
  %5 = load i32* %i, align 4, !dbg !68
  %6 = icmp slt i32 %5, %4, !dbg !68
  br i1 %6, label %bb1, label %bb3, !dbg !68

bb3:                                              ; preds = %bb2
  %7 = load i32* %j, align 4, !dbg !67
  %8 = add nsw i32 %7, 1, !dbg !67
  store i32 %8, i32* %j, align 4, !dbg !67
  br label %bb4, !dbg !67

bb4:                                              ; preds = %bb3, %entry
  %9 = load i32* %j, align 4, !dbg !67
  %10 = load i32* %kk, align 4, !dbg !67
  %11 = icmp slt i32 %9, %10, !dbg !67
  br i1 %11, label %bb, label %return, !dbg !67

return:                                           ; preds = %bb4
  %retval6 = load i32* %retval, !dbg !70
  ret i32 %retval6, !dbg !70
}
...
!70 = metadata !{i32 29, i32 0, metadata !65, null}
