...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %kk, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !67
...
bb1:                                              ; preds = %bb2
  %1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !70
  %2 = load i32* %i, align 4, !dbg !69
  %3 = add nsw i32 %2, 1, !dbg !69
  store i32 %3, i32* %i, align 4, !dbg !69
  br label %bb2, !dbg !69

bb2:                                              ; preds = %bb1, %bb
  %4 = load i32* %i, align 4, !dbg !69
  %5 = load i32* %c, align 4, !dbg !69
  %6 = icmp slt i32 %4, %5, !dbg !69
  br i1 %6, label %bb1, label %bb3, !dbg !69

bb3:                                              ; preds = %bb2
  %7 = load i32* %j, align 4, !dbg !68
  %8 = add nsw i32 %7, 1, !dbg !68
  store i32 %8, i32* %j, align 4, !dbg !68
  br label %bb4, !dbg !68

bb4:                                              ; preds = %bb3, %entry
  %9 = load i32* %kk, align 4, !dbg !68
  %10 = load i32* %j, align 4, !dbg !68
  %11 = icmp slt i32 %10, %9, !dbg !68
  br i1 %11, label %bb, label %return, !dbg !68
...
!71 = metadata !{i32 29, i32 0, metadata !65, null}
