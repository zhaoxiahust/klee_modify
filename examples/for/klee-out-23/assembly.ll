...
entry:
  ...
  store i32 100, i32* %c, align 4, !dbg !64
  store i32 100, i32* %cc, align 4, !dbg !66
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !67
  %1 = call i32 (...)* @klee_make_symbolic(i32* %kk, i64 4, i8* getelementptr inbounds ([14 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !68
...
bb1:                                              ; preds = %bb2
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !71
  %3 = load i32* %i, align 4, !dbg !70
  %4 = add nsw i32 %3, 1, !dbg !70
  store i32 %4, i32* %i, align 4, !dbg !70
  br label %bb2, !dbg !70

bb2:                                              ; preds = %bb1, %bb
  %5 = load i32* %c, align 4, !dbg !70
  %6 = load i32* %i, align 4, !dbg !70
  %7 = icmp slt i32 %6, %5, !dbg !70
  br i1 %7, label %bb1, label %bb3, !dbg !70

bb3:                                              ; preds = %bb2
  %8 = load i32* %j, align 4, !dbg !69
  %9 = add nsw i32 %8, 1, !dbg !69
  store i32 %9, i32* %j, align 4, !dbg !69
  br label %bb4, !dbg !69

bb4:                                              ; preds = %bb3, %entry
  %10 = load i32* %kk, align 4, !dbg !69
  %11 = load i32* %j, align 4, !dbg !69
  %12 = icmp slt i32 %11, %10, !dbg !69
  br i1 %12, label %bb, label %return, !dbg !69

return:                                           ; preds = %bb4
  %retval6 = load i32* %retval, !dbg !72
  ret i32 %retval6, !dbg !72
}
...
!64 = metadata !{i32 8, i32 0, metadata !65, null}
!65 = metadata !{i32 524299, metadata !0, i32 7, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 11, i32 0, metadata !65, null}
!67 = metadata !{i32 16, i32 0, metadata !65, null}
!68 = metadata !{i32 17, i32 0, metadata !65, null}
!69 = metadata !{i32 18, i32 0, metadata !65, null}
!70 = metadata !{i32 20, i32 0, metadata !65, null}
