...
@.str3 = private constant [3 x i8] c"no\00", align 1
...
bb:                                               ; preds = %bb4
  %2 = load i32* %c, align 4, !dbg !70
  %3 = icmp sgt i32 %2, 999, !dbg !70
  br i1 %3, label %bb1, label %bb2, !dbg !70
...
bb2:                                              ; preds = %bb
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !72
  br label %bb3, !dbg !72

bb3:                                              ; preds = %bb2, %bb1
  %6 = load i32* %j, align 4, !dbg !69
  %7 = add nsw i32 %6, 1, !dbg !69
  store i32 %7, i32* %j, align 4, !dbg !69
  br label %bb4, !dbg !69

bb4:                                              ; preds = %bb3, %entry
  %8 = load i32* %kk, align 4, !dbg !69
  %9 = load i32* %j, align 4, !dbg !69
  %10 = icmp slt i32 %9, %8, !dbg !69
  br i1 %10, label %bb, label %return, !dbg !69

return:                                           ; preds = %bb4
  %retval6 = load i32* %retval, !dbg !73
  ret i32 %retval6, !dbg !73
}
...
!73 = metadata !{i32 29, i32 0, metadata !65, null}
