...
bb:                                               ; preds = %entry
  %3 = load i32* %m, align 4, !dbg !78
  %4 = sext i32 %3 to i64, !dbg !78
  %5 = inttoptr i64 %4 to i8*, !dbg !78
  %6 = call i32 @pthread_create(i64* noalias %thread, %union.pthread_attr_t* noalias null, i8* (i8*)* @func, i8* noalias %5) nounwind, !dbg !78
  %7 = call i32 @putchar(i32 104) nounwind, !dbg !79
...
!79 = metadata !{i32 30, i32 0, metadata !76, null}
!80 = metadata !{i32 34, i32 0, metadata !76, null}
