...
entry:
  ...
  %1 = load i32* %cc, align 4, !dbg !66
  %2 = icmp sgt i32 %1, 100, !dbg !66
  br i1 %2, label %bb, label %return, !dbg !66
...
bb1:                                              ; preds = %bb2
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !68
  %4 = load i32* %i, align 4, !dbg !67
  %5 = add nsw i32 %4, 1, !dbg !67
  store i32 %5, i32* %i, align 4, !dbg !67
  br label %bb2, !dbg !67

bb2:                                              ; preds = %bb1, %bb
  %6 = load i32* %c, align 4, !dbg !67
  %7 = load i32* %i, align 4, !dbg !67
  %8 = icmp slt i32 %7, %6, !dbg !67
  br i1 %8, label %bb1, label %return, !dbg !67

return:                                           ; preds = %entry, %bb2
  %retval4 = load i32* %retval, !dbg !69
  ret i32 %retval4, !dbg !69
}
...
!67 = metadata !{i32 14, i32 0, metadata !65, null}
!68 = metadata !{i32 16, i32 0, metadata !65, null}
!69 = metadata !{i32 19, i32 0, metadata !65, null}
