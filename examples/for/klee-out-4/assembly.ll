...
@.str2 = private constant [5 x i8] c"fuck\00", align 1
...
entry:
  ...
  %1 = call i32 (...)* @klee_make_symbolic(i32* %cc, i64 4, i8* getelementptr inbounds ([11 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !66
  store i32 0, i32* %i, align 4, !dbg !67
  br label %bb1, !dbg !67

bb:                                               ; preds = %bb1
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !68
...
bb3:                                              ; preds = %bb4
  %8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !70
