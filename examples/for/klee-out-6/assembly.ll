...
entry:
  ...
  %0 = load i8*** %argv_addr, align 8, !dbg !64
  %1 = getelementptr inbounds i8** %0, i64 3, !dbg !64
  %2 = load i8** %1, align 1, !dbg !64
  %3 = getelementptr inbounds i8* %2, i64 0, !dbg !64
  %4 = load i8* %3, align 1, !dbg !64
  %5 = sext i8 %4 to i32, !dbg !64
  store i32 %5, i32* %cc, align 4, !dbg !64
  %6 = load i8*** %argv_addr, align 8, !dbg !66
  %7 = getelementptr inbounds i8** %6, i64 3, !dbg !66
  %8 = load i8** %7, align 1, !dbg !66
  %9 = getelementptr inbounds i8* %8, i64 1, !dbg !66
  %10 = load i8* %9, align 1, !dbg !66
  %11 = sext i8 %10 to i32, !dbg !66
  store i32 %11, i32* %mm, align 4, !dbg !66
  %12 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !67
  store i32 0, i32* %j, align 4, !dbg !68
  br label %bb5, !dbg !68

bb:                                               ; preds = %bb5
  %13 = load i32* %mm, align 4, !dbg !69
  %14 = icmp eq i32 %13, 8, !dbg !69
  br i1 %14, label %bb1, label %bb4, !dbg !69
...
bb2:                                              ; preds = %bb3
  %15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !71
  %16 = load i32* %i, align 4, !dbg !70
  %17 = add nsw i32 %16, 1, !dbg !70
  store i32 %17, i32* %i, align 4, !dbg !70
  br label %bb3, !dbg !70

bb3:                                              ; preds = %bb2, %bb1
  %18 = load i32* %c, align 4, !dbg !70
  %19 = load i32* %i, align 4, !dbg !70
  %20 = icmp slt i32 %19, %18, !dbg !70
  br i1 %20, label %bb2, label %bb4, !dbg !70

bb4:                                              ; preds = %bb3, %bb
  %21 = load i32* %j, align 4, !dbg !68
  %22 = add nsw i32 %21, 1, !dbg !68
  store i32 %22, i32* %j, align 4, !dbg !68
  br label %bb5, !dbg !68

bb5:                                              ; preds = %bb4, %entry
  %23 = load i32* %j, align 4, !dbg !68
  %24 = load i32* %cc, align 4, !dbg !68
  %25 = icmp slt i32 %23, %24, !dbg !68
  br i1 %25, label %bb, label %return, !dbg !68

return:                                           ; preds = %bb5
  %retval7 = load i32* %retval, !dbg !72
  ret i32 %retval7, !dbg !72
}
...
!64 = metadata !{i32 13, i32 0, metadata !65, null}
!65 = metadata !{i32 524299, metadata !0, i32 7, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 14, i32 0, metadata !65, null}
!67 = metadata !{i32 15, i32 0, metadata !65, null}
...
!72 = metadata !{i32 26, i32 0, metadata !65, null}
