...
bb:                                               ; preds = %bb5
  %1 = load i32* %mm, align 4, !dbg !67
  %2 = icmp eq i32 %1, 8, !dbg !67
  br i1 %2, label %bb1, label %bb4, !dbg !67
...
bb2:                                              ; preds = %bb3
  %3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !69
  %4 = load i32* %i, align 4, !dbg !68
  %5 = add nsw i32 %4, 1, !dbg !68
  store i32 %5, i32* %i, align 4, !dbg !68
  br label %bb3, !dbg !68

bb3:                                              ; preds = %bb2, %bb1
  %6 = load i32* %c, align 4, !dbg !68
  %7 = load i32* %i, align 4, !dbg !68
  %8 = icmp slt i32 %7, %6, !dbg !68
  br i1 %8, label %bb2, label %bb4, !dbg !68

bb4:                                              ; preds = %bb3, %bb
  %9 = load i32* %j, align 4, !dbg !66
  %10 = add nsw i32 %9, 1, !dbg !66
  store i32 %10, i32* %j, align 4, !dbg !66
  br label %bb5, !dbg !66

bb5:                                              ; preds = %bb4, %entry
  %11 = load i32* %j, align 4, !dbg !66
  %12 = load i32* %cc, align 4, !dbg !66
  %13 = icmp slt i32 %11, %12, !dbg !66
  br i1 %13, label %bb, label %return, !dbg !66

return:                                           ; preds = %bb5
  %retval7 = load i32* %retval, !dbg !70
  ret i32 %retval7, !dbg !70
}
...
!64 = metadata !{i32 15, i32 0, metadata !65, null}
...
!68 = metadata !{i32 20, i32 0, metadata !65, null}
!69 = metadata !{i32 22, i32 0, metadata !65, null}
!70 = metadata !{i32 26, i32 0, metadata !65, null}
