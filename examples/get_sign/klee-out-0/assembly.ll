...
entry:
  ...
  %1 = load i8*** %argv_addr, align 8, !dbg !73
  %2 = getelementptr inbounds i8** %1, i64 0, !dbg !73
  %3 = load i8** %2, align 1, !dbg !73
  %4 = getelementptr inbounds i8* %3, i64 0, !dbg !73
  %5 = load i8* %4, align 1, !dbg !73
  store i8 %5, i8* %a, align 1, !dbg !73
  %6 = load i8* %a, align 1, !dbg !75
  %7 = sext i8 %6 to i32, !dbg !75
  %8 = trunc i32 %7 to i8, !dbg !75
  %9 = call i32 @get_sign(i8 signext %8) nounwind, !dbg !75
  store i32 %9, i32* %0, align 4, !dbg !75
  %10 = load i32* %0, align 4, !dbg !75
  store i32 %10, i32* %retval, align 4, !dbg !75
...
!1 = metadata !{i32 524329, metadata !"get_sign.c", metadata !"/home/kain/Documents/bishe/klee/examples/get_sign/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"get_sign.c", metadata !"/home/kain/Documents/bishe/klee/examples/get_sign/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_
...
!73 = metadata !{i32 17, i32 0, metadata !74, null}
