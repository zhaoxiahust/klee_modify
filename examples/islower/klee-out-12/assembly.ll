...
entry:
  ...
  %4 = icmp sgt i32 %3, 20, !dbg !82
  br i1 %4, label %bb, label %bb1, !dbg !82

bb:                                               ; preds = %entry
  %5 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !83
  br label %return, !dbg !83

bb1:                                              ; preds = %entry
  %6 = call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !84
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !86
...
!83 = metadata !{i32 41, i32 0, metadata !81, null}
!84 = metadata !{i32 43, i32 0, metadata !81, null}
!85 = metadata !{i32 53, i32 0, metadata !81, null}
!86 = metadata !{i32 66, i32 0, metadata !87, null}
!87 = metadata !{i32 524299, metadata !11, i32 62, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!88 = metadata !{i32 82, i32 0, metadata !87, null}
!89 = metadata !{i32 110, i32 0, metadata !87, null}
