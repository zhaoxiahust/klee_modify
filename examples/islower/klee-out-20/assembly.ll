...
@.str2 = private constant [4 x i8] c"kkk\00", align 1
...
entry:
  ...
  store i32 %1, i32* %b, align 4, !dbg !66
  %2 = load i32* %b, align 4, !dbg !67
  %3 = icmp sgt i32 %2, 20, !dbg !67
  br i1 %3, label %bb, label %bb1, !dbg !67

bb:                                               ; preds = %entry
  %4 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !68
  br label %return, !dbg !68

bb1:                                              ; preds = %entry
  %5 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !69
...
!0 = metadata !{i32 524334, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 false, i32 (i32, i8**)* @main} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 524329, metadata !"llll.c", metadata !"/home/kain/Documents/bishe/klee/examples/islower/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"llll.c", metadata !"/home/kain/Documents/bishe/klee/examples/islower/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit 
...
!64 = metadata !{i32 17, i32 0, metadata !65, null}
!65 = metadata !{i32 524299, metadata !0, i32 12, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 19, i32 0, metadata !65, null}
!67 = metadata !{i32 21, i32 0, metadata !65, null}
!68 = metadata !{i32 23, i32 0, metadata !65, null}
!69 = metadata !{i32 27, i32 0, metadata !65, null}
!70 = metadata !{i32 34, i32 0, metadata !65, null}
