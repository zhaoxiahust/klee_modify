...
@.str = private constant [3 x i8] c"hi\00", align 1
@.str1 = private constant [4 x i8] c"kkk\00", align 1
...
entry:
  ...
  %0 = load i32* %c, align 4, !dbg !64
  store i32 %0, i32* %b, align 4, !dbg !64
  %1 = load i32* %b, align 4, !dbg !66
  %2 = icmp sgt i32 %1, 20, !dbg !66
  br i1 %2, label %bb, label %bb1, !dbg !66

bb:                                               ; preds = %entry
  %3 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !67
  br label %return, !dbg !67

bb1:                                              ; preds = %entry
  %4 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !68
...
!64 = metadata !{i32 22, i32 0, metadata !65, null}
!65 = metadata !{i32 524299, metadata !0, i32 12, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 24, i32 0, metadata !65, null}
!67 = metadata !{i32 26, i32 0, metadata !65, null}
!68 = metadata !{i32 30, i32 0, metadata !65, null}
!69 = metadata !{i32 37, i32 0, metadata !65, null}
