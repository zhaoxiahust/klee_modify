...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !84
  %c1 = bitcast i32* %c to i8*, !dbg !86
  %1 = call i32 @pthread_create(i64* noalias %thread1, %union.pthread_attr_t* noalias null, i8* (i8*)* @hi, i8* noalias %c1) nounwind, !dbg !86
  %2 = load i32* %d, align 4, !dbg !87
  %3 = icmp sgt i32 %2, 100, !dbg !87
  br i1 %3, label %bb, label %return, !dbg !87

bb:                                               ; preds = %entry
  %4 = load i32* %c, align 4, !dbg !88
  %5 = icmp sgt i32 %4, 0, !dbg !88
  br i1 %5, label %bb2, label %bb3, !dbg !88

bb2:                                              ; preds = %bb
  %6 = call i32 @puts(i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !89
  br label %return, !dbg !89

bb3:                                              ; preds = %bb
  %7 = call i32 @puts(i8* getelementptr inbounds ([11 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !90
  br label %return, !dbg !90

return:                                           ; preds = %entry, %bb2, %bb3
  %retval5 = load i32* %retval, !dbg !91
  ret i32 %retval5, !dbg !91
}
...
!17 = metadata !{i32 524329, metadata !"memcpy.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !18} ; [ DW_TAG_file_type ]
!18 = metadata !{i32 524305, i32 0, i32 1, metadata !"memcpy.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!26 = metadata !{i32 524329, metadata !"memmove.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !27} ; [ DW_TAG_file_type ]
!27 = metadata !{i32 524305, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!35 = metadata !{i32 524329, metadata !"memset.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !36} ; [ DW_TAG_file_type ]
!36 = metadata !{i32 524305, i32 0, i32 1, metadata !"memset.c", metadata !"/home/kain/VC/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!84 = metadata !{i32 63, i32 0, metadata !85, null}
!85 = metadata !{i32 524299, metadata !10, i32 58, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 79, i32 0, metadata !85, null}
!87 = metadata !{i32 86, i32 0, metadata !85, null}
!88 = metadata !{i32 87, i32 0, metadata !85, null}
!89 = metadata !{i32 88, i32 0, metadata !85, null}
!90 = metadata !{i32 90, i32 0, metadata !85, null}
!91 = metadata !{i32 107, i32 0, metadata !85, null}
