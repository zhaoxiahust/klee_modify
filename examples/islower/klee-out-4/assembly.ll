...
entry:
  ...
  %"alloca point" = bitcast i32 0 to i32
  store i8* %ptr, i8** %ptr_addr
  %0 = call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !80
  %retval1 = load i8** %retval, !dbg !82
  ret i8* %retval1, !dbg !82
}
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !83
  %c1 = bitcast i32* %c to i8*, !dbg !85
  %1 = call i32 @pthread_create(i64* noalias %thread1, %union.pthread_attr_t* noalias null, i8* (i8*)* @hi, i8* noalias %c1) nounwind, !dbg !85
  %retval2 = load i32* %retval, !dbg !86
  ret i32 %retval2, !dbg !86
}
...
!82 = metadata !{i32 52, i32 0, metadata !81, null}
!83 = metadata !{i32 65, i32 0, metadata !84, null}
!84 = metadata !{i32 524299, metadata !11, i32 61, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 81, i32 0, metadata !84, null}
!86 = metadata !{i32 109, i32 0, metadata !84, null}
