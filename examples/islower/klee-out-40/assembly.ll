...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !87
  %c1 = bitcast i32* %c to i8*, !dbg !89
  %1 = call i32 @pthread_create(i64* noalias %thread1, %union.pthread_attr_t* noalias null, i8* (i8*)* @hi, i8* noalias %c1) nounwind, !dbg !89
  %2 = load i32* %d, align 4, !dbg !90
  %3 = icmp sgt i32 %2, 100, !dbg !90
  br i1 %3, label %bb, label %bb4, !dbg !90

bb:                                               ; preds = %entry
  %4 = load i32* %c, align 4, !dbg !91
  %5 = icmp sgt i32 %4, 0, !dbg !91
  br i1 %5, label %bb2, label %bb3, !dbg !91

bb2:                                              ; preds = %bb
  %6 = call i32 @puts(i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !92
  br label %bb4, !dbg !92

bb3:                                              ; preds = %bb
  %7 = call i32 @puts(i8* getelementptr inbounds ([11 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !93
  br label %bb4, !dbg !93

bb4:                                              ; preds = %bb3, %bb2, %entry
  %8 = load i64* %thread1, align 8, !dbg !94
  %9 = call i32 @pthread_join(i64 %8, i8** null) nounwind, !dbg !94
  %retval5 = load i32* %retval, !dbg !95
  ret i32 %retval5, !dbg !95
}
...
!87 = metadata !{i32 68, i32 0, metadata !88, null}
!88 = metadata !{i32 524299, metadata !10, i32 63, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!89 = metadata !{i32 84, i32 0, metadata !88, null}
!90 = metadata !{i32 91, i32 0, metadata !88, null}
!91 = metadata !{i32 92, i32 0, metadata !88, null}
!92 = metadata !{i32 93, i32 0, metadata !88, null}
!93 = metadata !{i32 95, i32 0, metadata !88, null}
!94 = metadata !{i32 108, i32 0, metadata !88, null}
!95 = metadata !{i32 112, i32 0, metadata !88, null}
