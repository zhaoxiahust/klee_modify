...
entry:
  ...
  %3 = getelementptr inbounds %union.pthread_mutex_t* %mutex1, i32 0, i32 0, !dbg !78
  %4 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 0, !dbg !78
  store i32 0, i32* %4, align 8, !dbg !78
  %5 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 1, !dbg !78
  store i32 0, i32* %5, align 4, !dbg !78
  %6 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 2, !dbg !78
  store i32 0, i32* %6, align 8, !dbg !78
  %7 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 3, !dbg !78
  store i32 0, i32* %7, align 4, !dbg !78
  %8 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 4, !dbg !78
  store i32 0, i32* %8, align 8, !dbg !78
  %9 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 5, !dbg !78
  store i32 0, i32* %9, align 4, !dbg !78
  %10 = getelementptr inbounds %struct.__pthread_mutex_s* %3, i32 0, i32 6, !dbg !78
  %11 = getelementptr inbounds %struct.__pthread_list_t* %10, i32 0, i32 0, !dbg !78
  store %struct.__pthread_list_t* null, %struct.__pthread_list_t** %11, align 8, !dbg !78
  %12 = getelementptr inbounds %struct.__pthread_list_t* %10, i32 0, i32 1, !dbg !78
  store %struct.__pthread_list_t* null, %struct.__pthread_list_t** %12, align 8, !dbg !78
  %13 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* %mutex1) nounwind, !dbg !79
  %14 = load i32* %b, align 4, !dbg !80
  %15 = icmp sgt i32 %14, 100, !dbg !80
  %16 = load i32* %a, align 4, !dbg !81
  br i1 %15, label %bb, label %bb4, !dbg !80

bb:                                               ; preds = %entry
  %17 = icmp sgt i32 %16, 20, !dbg !81
  br i1 %17, label %bb1, label %bb2, !dbg !81

bb1:                                              ; preds = %bb
  %18 = call i32 @puts(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !82
  br label %bb5, !dbg !82

bb2:                                              ; preds = %bb
  %19 = call i32 @puts(i8* getelementptr inbounds ([13 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !83
  br label %bb5, !dbg !83

bb4:                                              ; preds = %entry
  %20 = call i32 @aa(i32 %16) nounwind, !dbg !84
  br label %bb5, !dbg !84

bb5:                                              ; preds = %bb1, %bb2, %bb4
  %21 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %mutex1) nounwind, !dbg !85
  %retval6 = load i8** %retval, !dbg !86
  ret i8* %retval6, !dbg !86
}
...
entry:
  ...
  %0 = call i32 (...)* @kain() nounwind, !dbg !87
  %1 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !89
  %c1 = bitcast i32* %c to i8*, !dbg !90
  %2 = call i32 @pthread_create(i64* noalias %thread1, %union.pthread_attr_t* noalias null, i8* (i8*)* @hi, i8* noalias %c1) nounwind, !dbg !90
  %3 = load i32* %d, align 4, !dbg !91
  %4 = icmp sgt i32 %3, 100, !dbg !91
  br i1 %4, label %bb, label %bb4, !dbg !91

bb:                                               ; preds = %entry
  %5 = load i32* %c, align 4, !dbg !92
  %6 = icmp sgt i32 %5, 0, !dbg !92
  br i1 %6, label %bb2, label %bb3, !dbg !92

bb2:                                              ; preds = %bb
  %7 = call i32 @puts(i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !93
  br label %bb4, !dbg !93

bb3:                                              ; preds = %bb
  %8 = call i32 @puts(i8* getelementptr inbounds ([11 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !94
  br label %bb4, !dbg !94

bb4:                                              ; preds = %bb3, %bb2, %entry
  %9 = load i64* %thread1, align 8, !dbg !95
  %10 = call i32 @pthread_join(i64 %9, i8** null) nounwind, !dbg !95
  %retval5 = load i32* %retval, !dbg !96
  ret i32 %retval5, !dbg !96
}
...
!79 = metadata !{i32 26, i32 0, metadata !77, null}
!80 = metadata !{i32 34, i32 0, metadata !77, null}
!81 = metadata !{i32 35, i32 0, metadata !77, null}
!82 = metadata !{i32 36, i32 0, metadata !77, null}
!83 = metadata !{i32 38, i32 0, metadata !77, null}
!84 = metadata !{i32 40, i32 0, metadata !77, null}
!85 = metadata !{i32 52, i32 0, metadata !77, null}
!86 = metadata !{i32 54, i32 0, metadata !77, null}
!87 = metadata !{i32 69, i32 0, metadata !88, null}
!88 = metadata !{i32 524299, metadata !10, i32 63, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!89 = metadata !{i32 71, i32 0, metadata !88, null}
!90 = metadata !{i32 87, i32 0, metadata !88, null}
!91 = metadata !{i32 94, i32 0, metadata !88, null}
!92 = metadata !{i32 95, i32 0, metadata !88, null}
!93 = metadata !{i32 96, i32 0, metadata !88, null}
!94 = metadata !{i32 98, i32 0, metadata !88, null}
!95 = metadata !{i32 111, i32 0, metadata !88, null}
!96 = metadata !{i32 115, i32 0, metadata !88, null}
