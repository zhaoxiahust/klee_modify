...
@.str1 = private constant [9 x i8] c"fuck you\00", align 1
@.str2 = private constant [6 x i8] c"input\00", align 1
...
entry:
  ...
  %0 = call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !82
  %retval1 = load i8** %retval, !dbg !83
  ret i8* %retval1, !dbg !83
}
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !84
  ...
  %retval2 = load i32* %retval, !dbg !87
  ret i32 %retval2, !dbg !87
}
...
!83 = metadata !{i32 52, i32 0, metadata !81, null}
!84 = metadata !{i32 65, i32 0, metadata !85, null}
!85 = metadata !{i32 524299, metadata !11, i32 61, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 81, i32 0, metadata !85, null}
!87 = metadata !{i32 109, i32 0, metadata !85, null}
