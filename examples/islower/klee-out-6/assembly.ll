...
@.str1 = private constant [6 x i8] c"input\00", align 1
...
entry:
  ...
  %"alloca point" = bitcast i32 0 to i32
  store i8* %ptr, i8** %ptr_addr
  store i32 3, i32* %a, align 4, !dbg !80
  %0 = call i32 (...)* @klee_make_symbolic(i32* %a, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !82
  %1 = load i32* %a, align 4, !dbg !83
  %2 = icmp sgt i32 %1, 20, !dbg !83
  br i1 %2, label %bb, label %bb1, !dbg !83

bb:                                               ; preds = %entry
  %3 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !84
  br label %bb1, !dbg !84

bb1:                                              ; preds = %bb, %entry
  %4 = call i32 @puts(i8* getelementptr inbounds ([9 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !85
  %retval2 = load i8** %retval, !dbg !86
  ret i8* %retval2, !dbg !86
}
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %c, i64 4, i8* getelementptr inbounds ([6 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !87
...
!11 = metadata !{i32 524334, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 61, metadata !12, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 false, i32 (i32, i8**)* @main} ; [ DW_TAG_subprogram ]
...
!82 = metadata !{i32 33, i32 0, metadata !81, null}
!83 = metadata !{i32 40, i32 0, metadata !81, null}
!84 = metadata !{i32 41, i32 0, metadata !81, null}
!85 = metadata !{i32 48, i32 0, metadata !81, null}
!86 = metadata !{i32 52, i32 0, metadata !81, null}
!87 = metadata !{i32 65, i32 0, metadata !88, null}
!88 = metadata !{i32 524299, metadata !11, i32 61, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!89 = metadata !{i32 81, i32 0, metadata !88, null}
!90 = metadata !{i32 109, i32 0, metadata !88, null}
