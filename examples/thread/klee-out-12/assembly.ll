...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %m, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !78
  %1 = load i32* %m, align 4, !dbg !80
  %2 = icmp eq i32 %1, 0, !dbg !80
  br i1 %2, label %bb, label %bb1, !dbg !80

bb:                                               ; preds = %entry
  %3 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([6 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !81
  br label %return, !dbg !81

bb1:                                              ; preds = %entry
  %4 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([4 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !82
  br label %return, !dbg !82

return:                                           ; preds = %bb, %bb1
  %retval3 = load i8** %retval, !dbg !83
  ret i8* %retval3, !dbg !83
}
...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic(i32* %m, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !84
  %1 = load i32* %m, align 4, !dbg !86
  %2 = icmp eq i32 %1, 77, !dbg !86
  br i1 %2, label %bb, label %return, !dbg !86

bb:                                               ; preds = %entry
  %3 = call i32 @putchar(i32 104) nounwind, !dbg !87
  br label %return, !dbg !87

return:                                           ; preds = %entry, %bb
  %retval2 = load i32* %retval, !dbg !88
  ret i32 %retval2, !dbg !88
}

define i32 @putchar(i32 %c) nounwind {
entry:
  %x = alloca i8, align 1
  %0 = trunc i32 %c to i8, !dbg !89
  store i8 %0, i8* %x, align 1, !dbg !89
  %1 = call i64 @write(i32 1, i8* %x, i64 1) nounwind, !dbg !90
  ret i32 1, !dbg !91
}
...
!78 = metadata !{i32 8, i32 0, metadata !79, null}
...
!82 = metadata !{i32 13, i32 0, metadata !79, null}
!83 = metadata !{i32 14, i32 0, metadata !79, null}
!84 = metadata !{i32 23, i32 0, metadata !85, null}
!85 = metadata !{i32 524299, metadata !6, i32 17, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 27, i32 0, metadata !85, null}
!87 = metadata !{i32 37, i32 0, metadata !85, null}
!88 = metadata !{i32 52, i32 0, metadata !85, null}
!89 = metadata !{i32 17, i32 0, metadata !49, null}
!90 = metadata !{i32 18, i32 0, metadata !49, null}
!91 = metadata !{i32 19, i32 0, metadata !49, null}
