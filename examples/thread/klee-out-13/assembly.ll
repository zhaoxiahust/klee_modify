...
bb1:                                              ; preds = %bb, %entry
  %4 = load i64* %thread, align 8, !dbg !78
  %5 = call i32 @pthread_join(i64 %4, i8** null) nounwind, !dbg !78
  %retval2 = load i32* %retval, !dbg !79
  ret i32 %retval2, !dbg !79
}
...
!78 = metadata !{i32 51, i32 0, metadata !75, null}
!79 = metadata !{i32 52, i32 0, metadata !75, null}
