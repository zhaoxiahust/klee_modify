...
@.str4 = private constant [3 x i8] c"hi\00", align 1
@.str5 = private constant [3 x i8] c"re\00", align 1
...
entry:
  ...
  %1 = load i32* %m, align 4, !dbg !76
  %2 = icmp eq i32 %1, 77, !dbg !76
  br i1 %2, label %bb, label %bb1, !dbg !76

bb:                                               ; preds = %entry
  %3 = call i32 @putchar(i32 104) nounwind, !dbg !77
  br label %bb1, !dbg !77

bb1:                                              ; preds = %bb, %entry
  %4 = load i8** %file, align 8, !dbg !78
  %5 = call i32 @strcmp(i8* %4, i8* getelementptr inbounds ([3 x i8]* @.str4, i64 0, i64 0)) nounwind readonly, !dbg !78
  %6 = icmp eq i32 %5, 0, !dbg !78
  br i1 %6, label %bb2, label %bb3, !dbg !78

bb2:                                              ; preds = %bb1
  %7 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([3 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !79
  br label %return, !dbg !79

bb3:                                              ; preds = %bb1
  %8 = call i32 @putchar(i32 106) nounwind, !dbg !80
  br label %return, !dbg !80

return:                                           ; preds = %bb2, %bb3
  %retval5 = load i32* %retval, !dbg !81
  ret i32 %retval5, !dbg !81
}
...
!76 = metadata !{i32 27, i32 0, metadata !75, null}
!77 = metadata !{i32 37, i32 0, metadata !75, null}
!78 = metadata !{i32 40, i32 0, metadata !75, null}
!79 = metadata !{i32 42, i32 0, metadata !75, null}
!80 = metadata !{i32 46, i32 0, metadata !75, null}
!81 = metadata !{i32 51, i32 0, metadata !75, null}
