...
entry:
  ...
  %3 = load i32* %m, align 4, !dbg !77
  %4 = icmp eq i32 %3, 77, !dbg !77
  br i1 %4, label %bb, label %bb1, !dbg !77

bb:                                               ; preds = %entry
  %5 = call i32 @putchar(i32 104) nounwind, !dbg !78
  br label %bb1, !dbg !78

bb1:                                              ; preds = %bb, %entry
  %6 = load i8** %file, align 8, !dbg !79
  %7 = call i32 @strcmp(i8* %6, i8* getelementptr inbounds ([3 x i8]* @.str5, i64 0, i64 0)) nounwind readonly, !dbg !79
  %8 = icmp eq i32 %7, 0, !dbg !79
  br i1 %8, label %bb2, label %bb3, !dbg !79

bb2:                                              ; preds = %bb1
  %9 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([3 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !80
  br label %return, !dbg !80

bb3:                                              ; preds = %bb1
  %10 = call i32 @putchar(i32 106) nounwind, !dbg !81
  br label %return, !dbg !81

return:                                           ; preds = %bb2, %bb3
  %retval5 = load i32* %retval, !dbg !82
  ret i32 %retval5, !dbg !82
}
...
!77 = metadata !{i32 27, i32 0, metadata !75, null}
!78 = metadata !{i32 37, i32 0, metadata !75, null}
!79 = metadata !{i32 40, i32 0, metadata !75, null}
!80 = metadata !{i32 42, i32 0, metadata !75, null}
!81 = metadata !{i32 46, i32 0, metadata !75, null}
!82 = metadata !{i32 51, i32 0, metadata !75, null}
