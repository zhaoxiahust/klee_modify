...
///////////////////////////////////////////////kain
  ...
  std::map <llvm::Instruction *, int> BranchFlag; ///////////////记录是否走过该分支的两种情况，
  int SymFlag; /////////////如果为0的话，正常，如果为1的话，第一次执行则两个分支都addStatet加上去 
  ///////////////////////如果为2的话，
  int ConstraintFlag;//////////////0不添加constraint，标记人为制造的分支
  ...
  /////////////////////////////////kain
  StatePair pthread_fork(ExecutionState &current, ref<Expr> condition, bool isInternal);
