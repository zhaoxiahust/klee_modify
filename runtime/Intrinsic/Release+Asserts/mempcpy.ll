...
bb:                                               ; preds = %entry, %bb
  ...
  %src.05 = getelementptr i8* %srcaddr, i64 %indvar
  %dest.04 = getelementptr i8* %destaddr, i64 %indvar
...
!0 = metadata !{i32 524334, i32 0, metadata !1, metadata !"mempcpy", metadata !"mempcpy", metadata !"mempcpy", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 true, i8* (i8*, i8*, i64)* @mempcpy} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 524329, metadata !"mempcpy.c", metadata !"/home/kain/Documents/bishe/klee/runtime/Intrinsic/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"mempcpy.c", metadata !"/home/kain/Documents/bishe/klee/runtime/Intrinsic/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
