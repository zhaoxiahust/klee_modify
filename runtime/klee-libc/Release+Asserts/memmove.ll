...
bb2:                                              ; preds = %bb3.preheader, %bb2
  %indvar17 = phi i64 [ %indvar.next18, %bb2 ], [ 0, %bb3.preheader ]
  %b.014 = getelementptr i8* %src, i64 %indvar17
  %a.013 = getelementptr i8* %dst, i64 %indvar17
  %3 = load i8* %b.014, align 1, !dbg !24
  store i8 %3, i8* %a.013, align 1, !dbg !24
  %indvar.next18 = add i64 %indvar17, 1
  %exitcond19 = icmp eq i64 %indvar.next18, %count
...
bb5:                                              ; preds = %bb.nph, %bb5
  %indvar = phi i64 [ 0, %bb.nph ], [ %indvar.next, %bb5 ]
  %tmp16 = sub i64 %4, %indvar
  %b.111 = getelementptr i8* %src, i64 %tmp16
  %a.110 = getelementptr i8* %dst, i64 %tmp16
...
!0 = metadata !{i32 524334, i32 0, metadata !1, metadata !"memmove", metadata !"memmove", metadata !"memmove", metadata !1, i32 12, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i1 false, i1 true, i8* (i8*, i8*, i64)* @memmove} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 524329, metadata !"memmove.c", metadata !"/home/kain/Documents/bishe/klee/runtime/klee-libc/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 524305, i32 0, i32 1, metadata !"memmove.c", metadata !"/home/kain/Documents/bishe/klee/runtime/klee-libc/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!7 = metadata !{i32 524329, metadata !"stddef.h", metadata !"/home/kain/Documents/bishe/install/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include", metadata !2} ; [ DW_TAG_file_type ]
